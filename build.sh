...
OUTPUT_FILENAME="TrafficLightButtons-${PLUGIN_VERSION}.zip"
# ============================================================================
WHATS_NEW=$(cat <<'EOF'
<ul>
...
write_gradle_properties() {
    ...
    sed -i "s/^pluginGroup = .*/pluginGroup = com.ddc.trafficlightbuttons/" gradle.properties
    sed -i "s/^pluginId = .*/pluginId = com.ddc.trafficlightbuttons/" gradle.properties
